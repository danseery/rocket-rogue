...
inline constexpr int sharedFuelCapacity = 30;
inline constexpr int sharedFuelCapacityPerFuelModule = 2;
...
inline constexpr double operatorEntryDistanceCells = 1.25;

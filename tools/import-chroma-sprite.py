...
def import_sprite(
    ...
    cleaned_pixels = [
        (0, 0, 0, 0) if is_chroma((red, green, blue, alpha)) else (red, green, blue, alpha)
...
def main() -> None:
    ...
    parser.add_argument(
        "--preserve-layout",
        action="store_true",
        help="Remove chroma pixels without cropping, scaling, or repositioning the source image.",
    )

...
- Early route advancement is explicit: the claimed 3-Common lunar Prospector contract opens Mars readiness; the claimed 4-Common Mars bay expansion opens Jupiter readiness; safe Io artifact recovery enables the Saturn slingshot; and a claimed Perfect Jupiter Flyby permanently opens Saturn.
...
- Chapter 2: Lunar Program - Moon arrival, landing, the 3-Common Prospector contract, and the first unique Support Drone/Drone Bay slot.
- Chapter 3: Red Frontier - Mars research, surface mining, and explicit fabrication of the empty second Drone Bay slot from 4 local Common Ore.

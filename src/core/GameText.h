...
namespace status {
inline constexpr std::string_view welcome = "Welcome to OREBIT.";
...
inline constexpr std::string_view refitWindowOpened = "Useful mission data earned one permanent shipyard refit.";
...
inline constexpr std::string_view flybyCompleted = "Flyby complete. The probe pass validated safe science and kept the vehicle moving.";
...
inline constexpr std::string_view miningDrillFailed = "Drill offline. Return, stow, tether, or recall.";
...
inline constexpr std::string_view provingBurnStarted = "Launch underway. Watch the active gauge and turn around before the return margin is gone.";
inline constexpr std::string_view transferBurnStarted = "Transfer underway. Reach the destination with enough fuel for arrival.";
inline constexpr std::string_view fuelReserveGone = "Fuel reserve is gone. Rescue is responding.";
inline constexpr std::string_view returnBurnRotating = "Turnaround confirmed. Fly the return leg home.";
...
inline constexpr std::string_view extraProvingData = "Extra proving telemetry validated. The curve is opening up, and so is the temptation.";
inline constexpr std::string_view missionDataBanked = "Mission telemetry validated. Keep testing, upgrading, and deciding how bold the next burn should be.";
...
inline constexpr std::string_view earlyReturnUseful = "Early return confirmed. Useful approach data recovered from the proving route.";
...
inline constexpr std::string_view blueprints = "Research Data";
...
inline constexpr std::string_view banked = "Stowed";
...
inline constexpr std::string_view miningStorage = "Mining storage";
inline constexpr std::string_view miningEngineEfficiency = "Mining engines";
inline constexpr std::string_view damage = "Damage";
...
inline constexpr std::string_view miningStorageChip = "STORE";
inline constexpr std::string_view miningEngineEfficiencyChip = "HAUL";
...
inline constexpr std::string_view installPermanently = "Install";
...
inline constexpr std::string_view keepCredits = "Keep Credits";
inline constexpr std::string_view launchProvingFlight = "Prepare for launch";
inline constexpr std::string_view launch = "Launch";
inline constexpr std::string_view needFlightData = "Complete launch preparation";
...
inline constexpr std::string_view surveySite = "Survey";
inline constexpr std::string_view mineDeposit = "Mine";
inline constexpr std::string_view pushDeeper = "Dig";
...
namespace panel {
inline constexpr std::string_view title = "OREBIT";
...
inline constexpr std::string_view buildValue = "Vulkan 1.3 native / WebGL2 browser";
...
inline constexpr std::string_view blueprintUse = "Research Data use";
...
inline constexpr std::string_view postArrivalResearchReady = "Arrival opens committed approach choices before refit.";
inline constexpr std::string_view flybyDetail = "Pass through for credits and Research Data, closing Orbit and Landing for this visit.";
inline constexpr std::string_view orbitDetail = "Capture orbit for credits, Research Data, and a mapped descent; the Research board remains debug-only.";
...
inline constexpr std::string_view recoveredResourcesDetail = "Recovered samples, Research Data, and artifacts feed milestone and material-gated ship parts.";
...
inline constexpr std::string_view surfacePostureScoutDetail = "No payload is loaded yet. Survey the layers, dig to the level you want, then deploy the Mining Rig.";
...
inline constexpr std::string_view surfacePushDetail = "Tunnel one level deeper and make it the Mining Rig's new starting depth. Surveyed levels show what waits there.";
...
{
    return "+" + std::to_string(amount) + " Research Data";
}
...
{
    return "Complete launch preparation before committing to " + std::string(destinationName) + ".";
}

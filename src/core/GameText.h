...
inline constexpr std::string_view refitWindowOpened = "Useful flight data earned one permanent shipyard refit.";
...
inline constexpr std::string_view installPermanently = "Install permanently";

...
Hold DRILL after survey to cut the selected shaft; release to stop. The laser has no heat meter or cooldown. Survey and Bore both limit depth. The red beam is visible while firing and the completed shaft stays green. The ten-cell shaft cuts solid rows over three beam-seconds per full layer; empty rows require no work. Shaft selection avoids artifacts, seals and protected objective structures. The beam destroys every ordinary tile in its path, including bedrock and supply pockets; those pockets and bedrock grant no rewards. After the Moon, mission-sector bores stop at row 5 of the artifact layer, leaving the mineable approach for the rig even with higher Bore ranks. Intervening layers remain accessible. Existing excavation is never refilled. Excavated ore is loose physical cargo and is never credited from orbit. Falling laser debris disappears at the bottom instead of pooling there.

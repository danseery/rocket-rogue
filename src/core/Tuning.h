...
inline constexpr float temperatureShipFlashOpacity = 0.22F;
...
inline constexpr double cruiseCoolingStart = 0.70;
inline constexpr double cruiseCoolingResume = 0.40;
...
inline constexpr double miningDroneBaseHarvestRatePerSecond = 0.20;
...
inline constexpr double swarmSpawnIntervalMinimumSeconds = 0.08;
inline constexpr double swarmSpawnIntervalMaximumSeconds = 0.24;
inline constexpr double swarmWaveInitialDelayMinimumSeconds = 0.15;
inline constexpr double swarmWaveInitialDelayMaximumSeconds = 0.35;
...
inline constexpr double swarmSpawnAngularJitterRadians = 0.279252680319;
inline constexpr double swarmSpawnTangentialJitterCells = 1.5;
inline constexpr double swarmSpawnOutwardJitterCells = 1.25;
inline constexpr double swarmSpawnMinimumSpacingCells = 1.5;
inline constexpr int swarmSpawnPlacementAttempts = 6;
...
inline constexpr double swarmMeleeDiveRadiusCells = 0.88;
inline constexpr double swarmMeleeContactRadiusCells = 0.95;
inline constexpr int swarmMeleeAttackTokenCount = 3;
inline constexpr double swarmMeleeAttackCommitSeconds = 1.20;
inline constexpr double swarmMeleeAttackRequeueSeconds = 0.45;
...
inline constexpr double swarmSmallSeparationRadiusCells = 0.62;
inline constexpr double swarmLargeSeparationRadiusCells = 0.74;
inline constexpr double swarmEliteSeparationRadiusCells = 0.82;
inline constexpr double swarmSeparationSteeringWeight = 1.35;
inline constexpr int swarmSeparationSolverIterations = 3;
} // namespace mining

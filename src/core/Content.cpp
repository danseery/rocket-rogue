...
ContentCatalog createDefaultContent()
{
    ...
    catalog.surfaceUpgrades = {
        ...
        surfaceUpgrade(content::surfaceUpgrade::recoilBraces, "Recoil Braces", "Kickback struts turn hard-rock bonks into controlled shoves.", Rarity::Uncommon, SurfaceUpgradeCategory::Drone, {.hardRockBounceRelief = 0.24, .droneSpeed = 0.2}, {"drone", "recoil"}),
        surfaceUpgrade(content::surfaceUpgrade::oreHopper, "Ore Hopper", "A squat canister rig keeps good fragments from scattering into the dust.", Rarity::Common, SurfaceUpgradeCategory::Drone, {.oreYieldChance = 0.06, .extractionRiskRelief = 0.01}, {"drone", "yield"}),
        ...
        surfaceUpgrade(content::surfaceUpgrade::deepEchoMapper, "Deep Echo Mapper", "Low-frequency pings read deeper silhouettes before the scanner flare fades.", Rarity::Rare, SurfaceUpgradeCategory::Scanner, {.scannerRadius = 2.6, .hazardRelief = 0.015}, {"scanner", "depth"})
    };
    ...
    catalog.miniDrones = {
        ...
        miniDrone(content::drone::attackDrone, "Attack Drone", "Passive sentry fire for hostile worlds beyond the solar system.", Rarity::Rare, MiniDroneRole::Attack, {.enemyEncounterRelief = 0.05, .sentryDamagePerSecond = 3.2}, content::unlock::perimeterDrones, {"combat", "post-solar"}),
        miniDrone(content::drone::defenseDrone, "Defense Drone", "Projects a short-range shield around the mining drone under attack.", Rarity::Rare, MiniDroneRole::Defense, {.drillIntegrityRelief = 0.06, .enemyEncounterRelief = 0.08, .enemyDamageRelief = 0.32}, content::unlock::perimeterDrones, {"defense", "post-solar"})
    };

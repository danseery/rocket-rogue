...
inline constexpr std::string_view orbitalWork = "orbital_work";
inline constexpr std::string_view orbitalWorkPress = "orbital_work_press";
inline constexpr std::string_view orbitalWorkRelease = "orbital_work_release";
inline constexpr std::string_view resumeOrbitalFlight = "resume_orbital_flight";
inline constexpr std::string_view landFromOrbit = "land_from_orbit";

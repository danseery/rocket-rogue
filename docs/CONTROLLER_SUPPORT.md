...
| Physical Flight | Left/right shoulders rotate. Left stick left/right strafes relative to the ship; up/down applies proportional forward/reverse thrust. Left-stick click / C toggles cruise; View / M opens the paused system map. Manual steering/thrust cancels cruise. South starts Pulse Survey or holds Orbital Laser Dig when available; East resumes flight from inspection. |
